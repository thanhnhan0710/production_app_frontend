...
class _StandardScreenState extends State<StandardScreen> {
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        Container(
                          ...
                          child: Icon(Icons.assignment,
                              color: Colors.brown.shade800, size: 24),
                        ),
                        const SizedBox(width: 16),
                        Expanded(
                          child: Text(l10n.standardTitle,
                              style: TextStyle(
                                  fontSize: 22,
                    ...
                    Row(
                      children: [
                        if (isDesktop) ...[
                          _buildStatBadge(Icons.grid_view, "Total Standards",
                              "$total", Colors.blue),
                          const SizedBox(width: 16),
                          const Spacer(),
                        ],
  ...
  Widget _buildDesktopTable(
      BuildContext context, List<Standard> items, AppLocalizations l10n) {
              ...
              return SingleChildScrollView(
                ...
                child: ConstrainedBox(
                  ...
                  child: DataTable(
                    ...
                    columns: [
                      DataColumn(
                          label: Text(l10n.product.toUpperCase(),
                              style: _headerStyle)),
                      DataColumn(
                          label: Text("${l10n.dyeColor} & DE".toUpperCase(),
                              style: _headerStyle)),
                      const DataColumn(
                          label: Text("PHYSICAL SPECS",
                              style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 12,
                                  color: Colors.black87))),
                      const DataColumn(
                          label: Text("QUALITY SPECS",
                              style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 12,
                                  color: Colors.black87))),
                      const DataColumn(
                          label: Text("APPEARANCE & NOTE",
                              style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 12,
                                  color: Colors.black87))),
                        ...
                        cells: [
                          ...
                          DataCell(Column(
                            ...
                            children: [
                              ...
                              _specRow(Icons.difference, "ΔE",
                                  item.deltaE.isNotEmpty ? item.deltaE : "N/A",
                          ...
                          DataCell(Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              _specRow(Icons.straighten, "Width",
                                  "${item.widthMm} mm"),
                              _specRow(Icons.line_weight, "Thick",
                                  "${item.thicknessMm} mm"),
                              _specRow(Icons.scale, "Weight",
                                  "${item.weightGm} g/m"),
                              _specRow(Icons.grid_on, "Dens",
                          ...
                          DataCell(Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              _specRow(Icons.bolt, "Str",
                                  "${item.breakingStrength} daN",
                                  valueColor: Colors.red.shade700),
                              _specRow(
                                  Icons.expand, "Elong", "${item.elongation}%",
                                  valueColor: Colors.indigo),
                              _specRow(Icons.water_drop, "Wet",
                                  item.colorFastnessWet),
                              _specRow(
                                  Icons.wb_sunny, "Dry", item.colorFastnessDry),
                            ],
                          )),
                          DataCell(SizedBox(
                            width: 200,
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _mobileSpecChip("Str", "${item.breakingStrength}daN",
                        color: Colors.red.shade50),
                    _mobileSpecChip("Elong", "${item.elongation}%",
                        color: Colors.indigo.shade50),
                    _mobileSpecChip("Dens", item.weftDensity),
                    _mobileSpecChip("Wet", item.colorFastnessWet,
                        color: Colors.blue.shade50),
                    _mobileSpecChip("Dry", item.colorFastnessDry,
  ...
  void _showEditDialog(
    ...
    final strengthCtrl =
        TextEditingController(text: item?.breakingStrength ?? '');
    ...
    List<Product> prods =
        (prodState is ProductLoaded) ? prodState.products : [];
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(item == null ? l10n.addStandard : l10n.editStandard,
            style:
                  ...
                  children: [
                    ...
                    BlocBuilder<DyeColorCubit, DyeColorState>(
                      builder: (context, state) {
                        List<DyeColor> colors =
                            (state is DyeColorLoaded) ? state.colors : [];
                        return DropdownButtonFormField<int?>(
                          ...
                          items: [
                            const DropdownMenuItem<int?>(
                                value: null,
                                child: Text("Không chọn màu",
                                    style: TextStyle(color: Colors.grey))),
                            ...colors.map((c) => DropdownMenuItem<int?>(
                    ...
                    Row(children: [
                      Expanded(
                          child: TextFormField(
                              ...
                              decoration: _inputDeco(l10n.strength))),
                      const SizedBox(width: 12),
                      Expanded(
                          child: TextFormField(
                    ...
                    Row(children: [
                      Expanded(
                          child: TextFormField(
                              controller: dryCtrl,
                              decoration: _inputDeco(l10n.colorFastDry))),
                      const SizedBox(width: 12),
                      Expanded(
                          child: TextFormField(
                              controller: wetCtrl,
                              decoration: _inputDeco(l10n.colorFastWet))),
                    ]),
                    const SizedBox(height: 12),
                    Row(children: [
                      Expanded(
                          child: TextFormField(
                              ...
                              decoration: _inputDeco(l10n.deltaE))),
                      const SizedBox(width: 12),
                      Expanded(
                          child: TextFormField(
