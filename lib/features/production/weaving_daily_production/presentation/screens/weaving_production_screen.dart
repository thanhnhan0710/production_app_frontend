import 'dart:async'; // [MỚI] Dùng Timer
...
class WeavingProductionScreen extends StatefulWidget {
  ...
  @override
  State<WeavingProductionScreen> createState() =>
      _WeavingProductionScreenState();
}
...
class _WeavingProductionScreenState extends State<WeavingProductionScreen> {
  ...
  void _onWebSocketMessage(String message) {
    if (message == "REFRESH_WEAVING_PRODUCTIONS") {
      debugPrint("WebSocket: Làm mới danh sách Sản lượng Dệt.");
      if (mounted) _onSearch(); // Tự động search lại với filter hiện tại
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: widget.isEmbedded
          ? null
          : AppBar(
              title: Text(l10n.prodStatsTitle,
              ...
              actions: [
                ...
                IconButton(
                  ...
                  onPressed: () =>
                      context.read<WeavingProductionCubit>().recalculateToday(),
                )
              ],
            ),
      body: Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: TextField(
                    ...
                    onChanged: _onSearchTextChanged, // [CẬP NHẬT] Gắn debounce
                  ...
                  children: [
                    ...
                    PopupMenuButton<String>(
                      ...
                      itemBuilder: (context) => [
                        ...
                        PopupMenuItem(
                            value: 'this_year',
                            child: Text(l10n.filterThisYear)),
                      ],
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.filter_list,
                                size: 16, color: Color(0xFF003366)),
            ...
            child: BlocBuilder<WeavingProductionCubit, WeavingProductionState>(
              builder: (context, state) {
                ...
                if (state is WeavingProductionLoaded) {
                  ...
                  double sumKg =
                      list.fold(0, (sum, item) => sum + item.totalKg);
                  double sumMeters =
                      list.fold(0, (sum, item) => sum + item.totalMeters);
  ...
  Widget _buildSummaryCard(
      double totalKg, double totalMeters, int count, AppLocalizations l10n) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildStatItem(l10n.totalProduction, _currencyFormat.format(totalKg),
              "kg", Colors.white),
          Container(width: 1, height: 30, color: Colors.white30),
          _buildStatItem(l10n.totalLength, _currencyFormat.format(totalMeters),
              "m", Colors.white),
          Container(width: 1, height: 30, color: Colors.white30),
        ...
        Row(
          ...
          children: [
            ...
            if (unit.isNotEmpty) ...[
              ...
              Text(unit,
                  style:
                      TextStyle(color: color.withOpacity(0.9), fontSize: 11)),
            ]
          ],
        ),
      ],
  ...
  Widget _buildItemCard(BuildContext context, WeavingDailyProduction item,
