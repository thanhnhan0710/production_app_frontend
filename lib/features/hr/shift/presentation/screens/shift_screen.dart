...
class _ShiftScreenState extends State<ShiftScreen> {
  ...
  final Color _accentColor =
      const Color(0xFF3F51B5); // Màu Indigo cho Ca làm việc
  ...
  void _onWebSocketMessage(String message) {
    if (message == "REFRESH_SHIFTS") {
      debugPrint("WebSocket: Làm mới danh sách Ca làm việc (Shifts).");
      if (mounted) context.read<ShiftCubit>().loadShifts();
    }
  }

  // Xử lý Search với Timer
  void _onSearchChanged(String query) {
    ...
    _debounce = Timer(const Duration(milliseconds: 500), () {
      if (query.trim().isEmpty) {
        ...
        context.read<ShiftCubit>().searchShifts(query);
      }
    });
  }
                ...
                child: Column(
                  children: [
                    Row(
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(l10n.shiftTitle,
                                style: TextStyle(
                                    fontSize: 22,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.grey.shade800)),
                            const SizedBox(height: 2),
                            Text("Human Resources > Configuration",
                                style: TextStyle(
                    ...
                    Row(
                      children: [
                        if (isDesktop) ...[
                          _buildStatBadge(Icons.grid_view, "Total Shifts",
                              "$total", Colors.blue),
                          const SizedBox(width: 16),
                          const Spacer(),
                        ],
                        Expanded(
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              onChanged:
                                  _onSearchChanged, // [CẬP NHẬT] Tìm kiếm tức thì
  ...
  Widget _buildDesktopTable(
      BuildContext context, List<Shift> shifts, AppLocalizations l10n) {
              ...
              return SingleChildScrollView(
                ...
                child: ConstrainedBox(
                  ...
                  child: DataTable(
                    ...
                    columns: [
                      DataColumn(
                          label: Text(l10n.shiftName.toUpperCase(),
                              style: _headerStyle)),
                      DataColumn(
        ...
        return Container(
          ...
          child: ListTile(
            ...
            leading: CircleAvatar(
              ...
              child:
                  Icon(Icons.schedule, color: Colors.indigo.shade800, size: 20),
            ),
  ...
  void _showEditDialog(
      BuildContext context, Shift? item, AppLocalizations l10n) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(item == null ? l10n.addShift : l10n.editShift,
            style:
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  TextFormField(
                      controller: nameCtrl,
                      decoration: _inputDeco(l10n.shiftName),
          ...
          ElevatedButton(
            onPressed: () {
              if (formKey.currentState!.validate()) {
                ...
                context
                    .read<ShiftCubit>()
                    .saveShift(shift: newItem, isEdit: item != null);
                Navigator.pop(ctx);
