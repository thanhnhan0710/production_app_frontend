...
class ImportDeclarationDetailScreen extends StatefulWidget {
  ...
  @override
  State<ImportDeclarationDetailScreen> createState() =>
      _ImportDeclarationDetailScreenState();
}

class _ImportDeclarationDetailScreenState
    extends State<ImportDeclarationDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                            ...
                            : ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  return _buildDetailItem(
                                      context, decl.details[index], l10n);
                                },
                              ),
                      ),
                    ],
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text(l10n.addDeclarationItem,
            style: const TextStyle(
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text("${l10n.declarationType}: ${decl.type.name}",
                          style: TextStyle(
                              fontSize: 12,
              ...
              Column(
                ...
                children: [
                  ...
                  Text("${_currencyFormat.format(decl.totalTaxAmount)} VND",
                      style: const TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                          color: Colors.red)),
            ...
            child: Row(
              ...
              children: [
                _buildInfoColumn(
                    ...
                    _dateFormat.format(decl.declarationDate),
                    Icons.calendar_today),
                _buildInfoColumn(
                    l10n.invoiceNo, decl.invoiceNo ?? "-", Icons.receipt),
                _buildInfoColumn(l10n.billOfLading, decl.billOfLading ?? "-",
  ...
  Widget _buildDetailItem(BuildContext context, ImportDeclarationDetail detail,
    ...
    if (material == null) {
      ...
      if (matState is mat_bloc.MaterialLoaded) {
        material = matState.materials
            .where((m) => m.id == detail.materialId)
            .firstOrNull;
      }
    }
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(10)),
              child: const Center(
                  child: Icon(Icons.inventory_2, color: Colors.teal, size: 24)),
            ),
                ...
                children: [
                  Text(
                      material?.materialCode ??
                          "${l10n.materialLabel} #${detail.materialId}",
                      style: const TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.bold,
                          color: Colors.black87)),
                  ...
                  if (material != null)
                    Text(
                        "${material.materialCode} • ${material.materialType ?? 'Raw'}",
                        style: TextStyle(
                  ...
                  if (detail.hsCodeActual != null) ...[
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(4)),
                      child: Text(
                          "${l10n.actualHSCode}: ${detail.hsCodeActual}",
                          style: TextStyle(
                              fontSize: 11,
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.end,
              children: [
                Text("${_currencyFormat.format(detail.quantity)} kg",
                    style: const TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                        color: Colors.black87)),
                const SizedBox(height: 2),
                Text("@ \$${_currencyFormat.format(detail.unitPrice)}",
                    style:
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(l10n.noDeclarationItems,
              style: TextStyle(color: Colors.grey.shade500)),
          const SizedBox(height: 8),
          Text(l10n.addDeclarationItemPrompt,
  ...
  void _showAddDetailDialog(BuildContext context, AppLocalizations l10n,
    ...
    final priceCtrl =
        TextEditingController(text: detail?.unitPrice.toString() ?? '');
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(
            isEdit ? l10n.editDeclarationItem : l10n.addDeclarationItemTitle,
            style: const TextStyle(
                        ...
                        return InkWell(
                          ...
                          child: InputDecorator(
                            decoration: InputDecoration(
                                labelText: "${l10n.materialLabel} (Material)",
                                border: const OutlineInputBorder(),
                                suffixIcon: const Icon(Icons.search)),
                            child: Text(
                                selectedMaterial?.materialCode ??
                                    (isEdit
                                        ? "${l10n.materialLabel} #$selectedMaterialId"
                                        : l10n.selectMaterialPlaceholder),
                                style: TextStyle(
            ...
            onPressed: () {
              if (selectedMaterialId == null) {
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                    content: Text(l10n.errorSelectMaterial),
              ...
              final newDetail = ImportDeclarationDetail(
                  ...
                  hsCodeActual:
                      hsCodeCtrl.text.isNotEmpty ? hsCodeCtrl.text : null,
                  material: selectedMaterial);

              if (isEdit) {
                context
                    .read<ImportDeclarationCubit>()
                    .updateDetailItem(widget.id, newDetail);
              } else {
                context
                    .read<ImportDeclarationCubit>()
                    .addDetailItem(widget.id, newDetail);
              }
              Navigator.pop(ctx);
            },
