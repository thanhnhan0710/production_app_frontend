    ...
    return Scaffold(
      ...
      appBar: isDesktop
          ...
          : AppBar(
              ...
              title: Text(l10n.erpSystemShort, style: const TextStyle(color: Colors.white)),
              actions: [
                IconButton(
                           ...
                           Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(l10n.pageContent(currentPath), style: TextStyle(color: Colors.grey[500], fontSize: 18)),
                              ],
                            ),
                           )
                        ]
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(l10n.oppermannHeader, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18), overflow: TextOverflow.ellipsis),
                      const SizedBox(height: 4), 
                      Text(l10n.erpSystemShort, style: const TextStyle(color: Colors.white70, fontSize: 12), overflow: TextOverflow.ellipsis),
                    ],
                  ),
                )
              ],
                  ...
                  _buildExpansionGroup(
                    ...
                    children: [
                      ...
                      _buildSubExpansionGroup(
                        ...
                        children: [
                          _buildLevel3MenuItem(Icons.store_mall_directory, l10n.warehouseTitle, '/warehouses', currentPath),
                          _buildLevel3MenuItem(Icons.layers, l10n.materialTitle, '/materials', currentPath),
                          _buildLevel3MenuItem(Icons.local_shipping, l10n.supplierTitle, '/suppliers', currentPath),
                          _buildLevel3MenuItem(Icons.shopping_bag, l10n.productTitle, '/products', currentPath),
                          _buildLevel3MenuItem(Icons.straighten, l10n.unitTitle, '/units', currentPath),
                          _buildLevel3MenuItem(Icons.color_lens, l10n.dyeColorTitle, '/dye-colors', currentPath),
                        ]
                      ),
                      ...
                      _buildSubExpansionGroup(
                        ...
                        children: [
                          _buildLevel3MenuItem(Icons.receipt_long, l10n.importDeclarationTitle, '/import-declarations', currentPath),
                          _buildLevel3MenuItem(Icons.shopping_cart_checkout, l10n.purchaseOrderTitle, '/purchase-orders', currentPath),
                        ]
                      ),
                      ...
                      _buildSubExpansionGroup(
                        ...
                        children: [
                          _buildLevel3MenuItem(Icons.move_to_inbox, l10n.stockInTitle, '/stock-in', currentPath),
                          
                          // Header giả lập cho Xuất kho
                          _buildSubHeader(l10n.stockOutHeader),
                          _buildLevel3MenuItem(Icons.output, l10n.materialExport, '/material-exports', currentPath),
                          _buildLevel3MenuItem(Icons.output, l10n.semiFinishedExport, '#', currentPath),
                          _buildLevel3MenuItem(Icons.output, l10n.finishedProductExport, '#', currentPath),
                        ]
                      ),
                      ...
                      _buildSubExpansionGroup(
                        ...
                        children: [
                          _buildLevel3MenuItem(Icons.grid_view, l10n.materialTitle, '/inventorys', currentPath),
                          _buildLevel3MenuItem(Icons.grid_view, l10n.semiFinishedProducts, '#', currentPath),
                          _buildLevel3MenuItem(Icons.grid_view, l10n.finishedProducts, '#', currentPath),
                        ]
                      ),
                      ...
                      // 5. Quản lý lô
                       _buildSubExpansionGroup(
                        ...
                        children: [
                          _buildLevel3MenuItem(Icons.fact_check, l10n.materialBatches, '/batches', currentPath),
                        ]
                      ),
                    ],
                  ),
                   ...
                   _buildExpansionGroup(
                    ...
                    children: [
                      ...
                      _buildSubExpansionGroup(
                        ...
                        children: [
                          _buildLevel3MenuItem(Icons.settings_input_component, l10n.machineTitle, '/machines', currentPath),
                          _buildLevel3MenuItem(Icons.all_inbox, l10n.basketTitle, '/baskets', currentPath),
                        ]
                      ),
                      // 2. Dệt
                      _buildSubExpansionGroup(
                      ...
                      // Các mục đơn (Level 2)
                      _buildSubMenuItem(Icons.format_color_fill, l10n.dyeing, '#', currentPath),
                      _buildSubMenuItem(Icons.print, l10n.printing, '#', currentPath),
                      _buildSubMenuItem(Icons.shield, l10n.safeFinishedProducts, '#', currentPath),
                      ...
                      // Đóng gói Group
                       _buildSubExpansionGroup(
                        ...
                        childrenRoutes: [],
                        children: [
                          _buildLevel3MenuItem(Icons.album, l10n.rolling, '#', currentPath),
                          _buildLevel3MenuItem(Icons.content_cut, l10n.cutting, '#', currentPath),
                        ]
                      ),
                    ]
                   ),
                  ...
                  if (isAdmin)
                   _buildExpansionGroup(
                    ...
                    children: [
                      ...
                      _buildSubMenuItem(Icons.history, l10n.activityLog, '/logs', currentPath),
                    ]
                  ),
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: Text(l10n.productionOutput, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: _primaryColor), overflow: TextOverflow.ellipsis)),
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  subtitle: Text(l10n.justNow, style: const TextStyle(fontSize: 12)),
                  trailing: Container(
                    padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                    decoration: BoxDecoration(color: Colors.green.withOpacity(0.1), borderRadius: BorderRadius.circular(4)),
                    child: Text(l10n.statusDone, style: const TextStyle(color: Colors.green, fontSize: 10, fontWeight: FontWeight.bold)),
                  ),
                );
              },
            ),
